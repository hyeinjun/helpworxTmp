    ...
    <v-app>
      <v-main class="ma-3">
        <v-container fluid>
          <v-row>
            <v-col>
          <div class="pageTitle">정보 수정 요청 상세</div>
          </v-col>
            <v-spacer></v-spacer>
            <v-col>
          ...
          <v-card class="pa-5">
            <info-mod-req-detail-card @reqId="setReqId" @state="setState" />
            ...
            <v-row class="justify-center mt-5 mb-2">
              <div class="mr-0">
                <v-col
                  ...
                  v-if="state == '대기'"
                >
                  <v-btn color="rgba(42, 46, 72)" dark @click="goInfoModify"
                    >수정</v-btn
                  >
                </v-col>
              </div><div class="mr-0">
              <v-col cols="12" sm="1" xs="2" class="pa-1">
                <v-btn color="rgb(42, 46, 72)" dark @click="goBack"
                  >닫기</v-btn
                ></v-col
              ></div><div class="mr-0"><v-col
                cols="12"
                sm="1"
                xs="2"
                class="pa-1"
...
export default {
  ...
  methods: {
    ...
    goInfoModify() {
      console.log(this.reqId);
      this.$router.push("/customer/info/modify/" + this.reqId);
    },
  },
};
</script>
